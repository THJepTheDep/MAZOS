...
class TextEditor:
    ...
    def __init__(self, root):
        ...
        # Initializing Status
        self.status.set("Welcome To Maz-EDIT")
        # Creating Menubar
    ...
    def infoabout(self):
        messagebox.showinfo("About Text Editor", "Maz-EDIT is a simple text editor included with the Maz OS")
